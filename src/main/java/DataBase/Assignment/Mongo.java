...
public class Mongo {
	...
	public static void main (String args[]) throws IOException {
		String line = "";
		String splitBy = ",";
		BufferedReader br = new BufferedReader(new FileReader("/Users/sid/Desktop/BigData.csv"));
		
		
        FileWriter file = new FileWriter("Peds_output.json");
